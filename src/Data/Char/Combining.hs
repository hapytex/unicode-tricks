...
data CombiningCharacter
  ...
  | -- | The combining character @COMBINING GRAVE TONE MARK@ from the Unicode standard, defined by @'\\x0340'@ (&#x2022;&#x0340;).
    CombiningGraveToneMark
  | -- | The combining character @COMBINING ACUTE TONE MARK@ from the Unicode standard, defined by @'\\x0341'@ (&#x2022;&#x0341;).
  ...
  | -- | The combining character @COMBINING GREEK KORONIS@ from the Unicode standard, defined by @'\\x0343'@ (&#x2022;&#x0343;).
    CombiningGreekKoronis
  | -- | The combining character @COMBINING GREEK DIALYTIKA TONOS@ from the Unicode standard, defined by @'\\x0344'@ (&#x2022;&#x0344;).
...
combiningToUnicode ::
  ...
  CombiningCharacter ->
  -- | A Unicode 'Char'acter that is the codepoint of the given 'CombiningCharacter'. The
  Char
...
isCombiningCharacter ::
  ...
  Char ->
  -- | 'True' if the given 'Char'acter is a combining character; 'False' otherwise.
  Bool
...
decomposeCombiningSequence ::
  -- | The 'Char'acter to decompose.
  Char ->
  -- | A 2-tuple with the "root" 'Char'acter and the list of 'CombiningCharacter's that are applied to it.
...
stripCombiningSequence ::
  -- | The 'Char'acter that should be stripped from its applied 'CombiningCharacter's.
  Char ->
  -- | The "root" 'Char'acter that is the given 'Char'acter stripped from the applied 'CombiningCharacter's.
  Char
...
stripCombinings ::
  -- | The given 'Text' object to strip 'CombiningCharacter's from, both through filtering and decomposing.
  Text ->
  -- | A 'Text' object where the 'CombiningCharacter's are filtered out.
  Text
...
decomposeCombining ::
  -- | The given 'Char'acter to decompose.
  Char ->
  -- | A 2-tuple of a 'Char'acter and a 'CombiningCharacter' wrapped in a 'Just' if the 'Char' can be decomposed; 'Nothing' otherwise.
...
composeCombiningSequence ::
  -- | The given 'Char'acter to start with.
  Char ->
  -- | The list of 'CombiningCharacter's to apply.
  [CombiningCharacter] ->
...
composeCombining ::
  -- | The given 'Char'acter that is combined with a 'CombiningCharacter'.
  Char ->
  -- | The given 'CombiningCharacter' that is applied to the given 'Char'acter.
  CombiningCharacter ->
  -- | A dedicated 'Char'acter wrapped in a 'Just' if such character exists, 'Nothing' otherwise.
  Maybe Char
